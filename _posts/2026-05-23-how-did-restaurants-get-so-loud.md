...
In some places, it's by design. In New York City, for example, the price of real estate is so high that restaurants need to turn over tables as fast as possible, and one way of doing that is [keeping the noise level high](https://pmc.ncbi.nlm.nih.gov/articles/PMC11673941/) so diners can't relax and instead just eat, pay and leave. 
